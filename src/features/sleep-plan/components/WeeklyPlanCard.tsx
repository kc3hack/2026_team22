...
export const WeeklyPlanCard: React.FC<WeeklyPlanCardProps> = ({
    ...
    const importanceBadge = {
        high: { label: '⚡ 重要', color: '#F87171', bg: 'rgba(239, 68, 68, 0.12)', border: 'rgba(239, 68, 68, 0.3)' },
        medium: { label: '● 普通', color: '#FBBF24', bg: 'rgba(245, 158, 11, 0.12)', border: 'rgba(245, 158, 11, 0.3)' },
        low: { label: '○ 軽め', color: '#34D399', bg: 'rgba(16, 185, 129, 0.12)', border: 'rgba(16, 185, 129, 0.3)' },
    }[plan.importance];
